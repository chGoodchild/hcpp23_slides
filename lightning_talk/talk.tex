...
\begin{minipage}[t]{0.6\textwidth} % Adjust the width as needed
  ...
  \begin{itemize}
    ...
    \pause
    \begin{enumerate}[(a)]
    \item yelling on all frequencies
    \end{enumerate}
    ...
    \pause
    \begin{enumerate}[(a)]
    \item directional links and cables
    \end{enumerate}

    \item Cost of directional links:
    \begin{enumerate}[(a)]
      \item how much do you communicate?
      \item cost of link to each peer?
      \item $\Rightarrow$ hierarchy with encryption
    \end{enumerate}
  \end{itemize}
