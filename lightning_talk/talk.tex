...
\begin{figure}
  ...
  \begin{tabular}{|c|p{8cm}|}
    ...
    CP & Content Provider \\
    \hline
    T1 & Tier 1 Internet Service Provider \\
    T2 & Tier 2 Internet Service Provider \\
    T3 & Tier 3 Internet Service Provider \\
    \hline
    P & Pleb \\
    \hline
  \end{tabular}
  \caption{Table of Terms and Explanations}
\end{table}
